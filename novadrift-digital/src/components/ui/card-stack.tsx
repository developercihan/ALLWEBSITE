        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          {activeItem.href ? (
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-slate-500 hover:text-[#00D1FF] transition"
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[#161616] text-sm text-slate-500">
            Görsel Yok
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5 md:p-8">
        <div className="truncate text-lg md:text-2xl font-black text-white uppercase tracking-tighter">
          {item.title}
        </div>
        {item.description ? (
          <div className="mt-1 md:mt-2 line-clamp-2 text-xs md:text-sm text-slate-300 font-light">
            {item.description}
          </div>
        ) : null}
      </div>
